	...
	public	___bb_blitzmax_code_archief__spel__gridwars_utils
	public	_bb_CycleColours
	public	_bb_DrawCircle
	public	_bb_FitValueToRange
	public	_bb_GetPlayTime
	public	_bb_LineCollide2
	public	_bb_PointInTri
	public	_bb_PointToPointDist
	public	_bb_Rect
	public	_bb_RectsOverlap
	public	_bb_SaveScreenshot
	public	_bb_SetupKeyTable
	public	_bb_TFormR
	public	_bb_TurnToFace
	public	_bb_bcol
	public	_bb_bcoldelta
	public	_bb_gcol
	public	_bb_gcoldelta
	public	_bb_keystring
	public	_bb_rcol
	public	_bb_rcoldelta
	section	"code" code
...
_bb_CycleColours:
	...
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	mov	eax,dword [_bb_rcol]
	mov	dword [ebp+-8],eax
	fild	dword [ebp+-8]
	fld	dword [_bb_rcoldelta]
	fdiv	dword [_621]
	fmul	dword [ebp-4]
	faddp	st1,st0
	sub	esp,8
	...
	call	_bbFloatToInt
	add	esp,8
	mov	dword [_bb_rcol],eax
	push	_240
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	cmp	dword [_bb_rcol],0
	jge	_241
	push	ebp
	push	_244
	call	dword [_bbOnDebugEnterScope]
...
_245:
	...
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	mov	eax,dword [_bb_gcol]
	mov	dword [ebp+-8],eax
	fild	dword [ebp+-8]
	fld	dword [_bb_gcoldelta]
	fdiv	dword [_622]
	fmul	dword [ebp-4]
	faddp	st1,st0
	sub	esp,8
	...
	call	_bbFloatToInt
	add	esp,8
	mov	dword [_bb_gcol],eax
	push	_253
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	cmp	dword [_bb_gcol],0
	jge	_254
	push	ebp
	push	_257
	call	dword [_bbOnDebugEnterScope]
...
_258:
	...
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	mov	eax,dword [_bb_bcol]
	mov	dword [ebp+-8],eax
	fild	dword [ebp+-8]
	fld	dword [_bb_bcoldelta]
	fdiv	dword [_623]
	fmul	dword [ebp-4]
	faddp	st1,st0
	sub	esp,8
	...
	call	_bbFloatToInt
	add	esp,8
	mov	dword [_bb_bcol],eax
	push	_266
	call	dword [_bbOnDebugEnterStm]
	add	esp,4
	cmp	dword [_bb_bcol],0
	jge	_267
	push	ebp
	push	_270
	call	dword [_bbOnDebugEnterScope]
...
_603:
	...
	add	esp,4
	mov	ebx,dword [ebp-8]
	mov	eax,dword [_bb_keystring]
	cmp	ebx,dword [eax+20]
	jb	_606
	call	_brl_blitz_ArrayBoundsError
_606:
	mov	esi,dword [_bb_keystring]
	shl	ebx,2
	add	esi,ebx
	mov	ebx,dword [ebp-4]
	inc	dword [ebx+4]
...
_223:
	dd	0
_214:
	db	"C:/Documents and Settings/Michiel/My Documents/Programmering/BlitzMax/Voorbeeld/Blitzmax Code archief, Spel, GridWars/utils.bmx",0
	align	4
_213:
	dd	_214
	dd	8
