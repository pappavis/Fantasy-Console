	...
	extrn	brl_retro_Mid
	public	__bb_blitzmax_code_archief__spel__gridwars_vectorfont
	public	_bb_bbdigit_Delete
	public	_bb_bbdigit_New
	public	bb_DrawDigit
	public	bb_DrawString
	public	bb_SetUpVectorFont
	public	bb_bbdigit
	public	bb_letterlen
	public	bb_letters
	section	"code" executable
__bb_blitzmax_code_archief__spel__gridwars_vectorfont:
	push	ebp
	mov	ebp,esp
	push	ebx
	cmp	dword [_75],0
...
_60:
	...
	add	esp,16
	inc	dword [eax+4]
	mov	dword [bb_letters],eax
	or	dword [_59],2
_64:
	push	_65
	call	dword [bbOnDebugEnterStm]
	add	esp,4
	call	bb_SetUpVectorFont
	push	_66
	call	dword [bbOnDebugEnterStm]
	add	esp,4
_21:
...
bb_bbdigit:
	...
	dd	bbObjectReserved
_56:
	db	"/media/Acropolis/Documents and Settings/Michiel/My Documents/Programmering/BlitzMax/Voorbeeld/Blitzmax Code archief, Spel, GridWars/vectorfont.bmx",0
	align	4
_55:
	dd	_56
	dd	9
