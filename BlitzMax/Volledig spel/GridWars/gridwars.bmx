...
?
Global g_v_num$ = "5.3"
Global version$ = "Version "+g_v_num+" - Apr 3, 2006"
...
'				Next
	...
	Method Kill(points:Int=True)
		...
		If sz < 4
			...
			If points
				Local sc:Int = 150
				sc:+ absorbcount*(absorbcount+1)/2*5
...
'		messtime = 180
	...
	Function MakePowerUp(tp:Int=-1)
		...
		' 0 - forward, 1 - circ, 2 - x bullet, 3 - speed, 4 - free man, 5 - free bomb
		' can always be 0,1
...
'			score.create(s$,px-10*6,py-32,True)
	...
	Function DrawScore()
		...
		DrawString(multiplier+"X", 236,10,3)			
