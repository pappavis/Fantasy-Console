...
part_LIST:brl.linkedlist.TList&=mem:p("bb_part_LIST")
trail_LIST:brl.linkedlist.TList&=mem:p("bb_trail_LIST")
gwlow%&=mem("bb_gwlow")
gwhi%&=mem("bb_gwhi")
ghlow%&=mem("bb_ghlow")
ghhi%&=mem("bb_ghhi")
